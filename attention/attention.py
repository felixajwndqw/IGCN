...
class SemanticModule(nn.Module):
    ...
    def __init__(self, in_dim):
        ...
        self.dec2 = _DecoderBlock(in_dim * 4, in_dim * 2)
        self.dec1 = _DecoderBlock(in_dim * 2, in_dim)
...
class CAM_Module(nn.Module):
    ...
    def forward(self, x):
        ...
        attention = self.align(energy_new)
...
class AttentionLayer(nn.Module):
    ...
    """
    def __init__(self, in_ch, AttentionModule=PAM_Module):
        super().__init__()
